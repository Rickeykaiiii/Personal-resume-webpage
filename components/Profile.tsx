...
const Profile: React.FC = () => {
  ...
  return (
    <div className="px-4 md:px-6 py-8 md:py-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      <div className="flex flex-col items-center mb-12 md:mb-16 text-center">
        ...
        <div 
          ...
          className="w-28 h-28 md:w-32 md:h-32 rounded-full border-4 border-white/5 shadow-2xl mb-5 md:mb-6 overflow-hidden bg-zinc-900 flex items-center justify-center group cursor-pointer relative transition-transform duration-500 hover:scale-105"
        >
          {!imageError ? (
            <img 
              src={imageSrc} 
            ...
            <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-900/40 via-black to-black text-blue-500">
              <span className="text-3xl md:text-4xl font-extralight tracking-[0.2em] ml-[0.2em]">RK</span>
        ...
        <h1 className="text-2xl md:text-3xl font-light tracking-widest text-white mb-1">洪葦楷</h1>
        <p className="text-blue-500 text-[10px] md:text-xs tracking-[0.25em] md:tracking-[0.3em] font-medium uppercase mb-4">IT Teacher | Graduate Student</p>
